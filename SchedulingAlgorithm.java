...
public class SchedulingAlgorithm {
    ...
    private static void findAvgTime(int processes[], int n, int burstTimes[], int quantum, int arrivalTimes[]) {
        int wt[] = new int[n];
        int tat[] = new int[n];
        int ct[] = new int[n];
        int rt[] = new int[n];
    ...
    private static void findWaitingTime(int processes[], int n, int burstTimes[], int wt[], int quantum, int arrivalTimes[], int ct[], int rt[]) {
    ...
    private static void findTurnAroundTime(int processes[], int n, int burstTimes[], int wt[], int tat[], int ct[], int arrivalTimes[]) {
        for (int i = 0; i < n; i++)
            tat[i] = ct[i] - arrivalTimes[i];
    }

    private static double calculateFCFSAvgWaitingTime(int[] burstTimes, int[] arrivalTimes) {
    ...
    private static void compareAlgorithmsEfficiency(double avgWaitingTimeRR, double avgWaitingTimeFCFS) {
